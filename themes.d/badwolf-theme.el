...
;; tree-sitter
 ;; treesit
`(treesit-font-lock-comment-face ((t (:foreground ,toffee))))
`(treesit-font-lock-constant-face ((t (:foreground ,dress))))
`(treesit-font-lock-doc-face ((t (:foreground ,toffee))))
`(treesit-font-lock-function-name-face ((t (:foreground ,tardis))))
`(treesit-font-lock-keyword-face ((t (:foreground ,dress))))
`(treesit-font-lock-preprocessor-face ((t (:foreground ,orange))))
`(treesit-font-lock-property-face ((t (:foreground ,lime))))
`(treesit-font-lock-string-face ((t (:foreground ,orange))))
`(treesit-font-lock-type-face ((t (:foreground ,orange))))
`(treesit-font-lock-variable-name-face ((t (:foreground ,dirtyblonde))))
`(treesit-font-lock-number-face ((t (:foreground ,brightgravel))))
`(treesit-font-lock-operator-face ((t (:foreground ,dalespale))))
`(treesit-font-lock-label-face ((t (:foreground ,dirtyblonde))))
`(treesit-font-lock-escape-face ((t (:foreground ,taffy))))
`(treesit-font-lock-punctuation-face ((t (:foreground ,lightgravel))))
`(treesit-font-lock-bracket-face ((t (:foreground ,coffee))))
`(treesit-font-lock-delimiter-face ((t (:foreground ,toffee))))
`(treesit-font-lock-special-face ((t (:foreground ,saltwatertaffy))))
`(treesit-font-lock-tag-face ((t (:foreground ,dress))))
`(treesit-font-lock-attribute-face ((t (:foreground ,tardis))))
`(treesit-font-lock-builtin-face ((t (:foreground ,coffee))))
`(treesit-font-lock-error-face ((t (:foreground ,taffy :underline t))))
